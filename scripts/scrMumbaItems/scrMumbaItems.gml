...
createMumbaItem("Witch's Staff", mumbaMagicStaff, "Shoots magic projectiles!", "Now you just need one of these hats to go with it, heheh!", sprMumbaMagicStaff, sprMumbaMagicStaffUI, 50, "W. Staff");
