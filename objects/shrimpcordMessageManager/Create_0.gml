...
createMessage=function(n, t, pp=sprShrimpcordDefaultIcon, h=current_hour, m=current_minute, addToProfileList=true) {
	/// @function createMessage(name, text, [profileImage], [hour], [minute], [addToProfileList])
	var inst=instance_create_depth(startX, startY, depth-1, shrimpcordMessage);
	with inst {
		visible=false;
		name=n;
		text=t;
